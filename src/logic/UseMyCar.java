...
public class UseMyCar {
	...
	public static void startGame(Car playerCar, TextField gameScreen) {
		...
		gameScreen.appendText("\t\t\t\t" + "CAR RACING");
		...
		while (i < 60)
		{
			...
			if (playerCar.getSpeedIncreaseStep() > 0){
        	  gameScreen.appendText( playerCar.getSpeedIncreaseStep() +" :: " +playerCar.getCarName() + " >>> : " +playerCar.getCurrentSpeed() +"\t\t" );
			}
			...
			//if mySecondCar speedIncreaseStep is positive (Acceleration)
       	   if (mySecondCar.getSpeedIncreaseStep() > 0){
        	   gameScreen.appendText(mySecondCar.getSpeedIncreaseStep() +" :: "  +mySecondCar.getCarName() + " >>> : " +mySecondCar.getCurrentSpeed() );
    	  ...
    	  { 
      	  ...
      	  {
    		gameScreen.appendText("there is an error");
      	  	}
          i++;       
		}  
		gameScreen.appendText( "/n");
